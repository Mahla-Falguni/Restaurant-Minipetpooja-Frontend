...
/*
=========================================================
RESET PASSWORD — shared across every role
Route: /reset-password/:token
Same token-verify-then-set-password flow for whichever role the
link was generated for — the backend doesn't need to know which
role it is, it just matches the token against the User model.
=========================================================
*/
